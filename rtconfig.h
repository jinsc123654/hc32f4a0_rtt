...
#define BSP_USING_PWM_TMRA_1
#define BSP_USING_PWM_TMRA_1_CH1
#define BSP_USING_PWM_TMRA_4
#define BSP_USING_PWM_TMRA_4_CH4
#define BSP_USING_PWM_TMRA_7
#define BSP_USING_PWM_TMRA_7_CH2
