...
#endif
#if defined(BSP_USING_SDIO1) && !defined(SDIO1_RX_DMA_INSTANCE)
#define SDIO1_RX_DMA_INSTANCE           CM_DMA1
#define SDIO1_RX_DMA_CHANNEL            DMA_CH2
#define SDIO1_RX_DMA_CLOCK              (PWC_FCG0_DMA2 | PWC_FCG0_AOS)
#define SDIO1_RX_DMA_TRIG_SELECT        AOS_DMA1_2
#define SDIO1_RX_DMA_TRANS_FLAG         DMA_FLAG_TC_CH2
#define SDIO1_RX_DMA_IRQn               BSP_DMA1_CH2_IRQ_NUM
#define SDIO1_RX_DMA_INT_PRIO           BSP_DMA1_CH2_IRQ_PRIO
#define SDIO1_RX_DMA_INT_SRC            INT_SRC_DMA1_TC2
...
#endif
#if defined(BSP_USING_SDIO1) && !defined(SDIO1_TX_DMA_INSTANCE)
#define SDIO1_TX_DMA_INSTANCE           CM_DMA1
#define SDIO1_TX_DMA_CHANNEL            DMA_CH3
#define SDIO1_TX_DMA_CLOCK              (PWC_FCG0_DMA1 | PWC_FCG0_AOS)
#define SDIO1_TX_DMA_TRIG_SELECT        AOS_DMA1_3
#define SDIO1_TX_DMA_TRANS_FLAG         DMA_FLAG_TC_CH3
#define SDIO1_TX_DMA_IRQn               BSP_DMA1_CH3_IRQ_NUM
#define SDIO1_TX_DMA_INT_PRIO           BSP_DMA1_CH3_IRQ_PRIO
#define SDIO1_TX_DMA_INT_SRC            INT_SRC_DMA1_TC3
